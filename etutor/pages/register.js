import { BsFillPersonFill, BsMailbox2, BsFillLockFill, BsKeyFill } from "react-icons/bs";
import {IoMailSharp} from "react-icons/io5"
import ImageRegister from "../public/images/study.png"
                ...
                <div className="card-body p-md-5">
                  <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          <BsFillPersonFill size={28} style={{ marginRight: 10 }}/>
                          <div className="form-outline flex-fill mb-0">
                            <input type="text" id="form3Example1c" className="form-control" placeholder="Họ tên"/>
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          <BsFillLockFill size={28} style={{ marginRight: 10 }}/>
                          <div className="form-outline flex-fill mb-0">
                    ...
                    <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                      ...
                      <img src={ImageRegister.src} className="img-fluid" alt="Sample image"/>
